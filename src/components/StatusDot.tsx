...
//   working  — amber, pulsing: in-flight (connecting / compiling) — traffic-light
//              "wait", distinct from the steady green of connected
//   error    — red
...
export type StatusTone = 'ok' | 'working' | 'error' | 'idle' | 'absent'
