...
These projects use the Websockets API:

# Pixelblaze Websockets API

-   The web app that your Pixelblaze serves from its IP address uses this API to do things like list and switch patterns, display watched variables, and many other things.
-   [Firestorm](https://github.com/simap/Firestorm) is an open-source React web app you can use to remote control many Pixelblaze at once. It will show which patterns exist on which boards, let you launch a pattern on all boards that have it, and sequence patterns as a playlist. You can also clone entire boards, copying all patterns from one to another.
-   [pixelblaze-client](https://github.com/zranger1/pixelblaze-client) is a Python project that uses the Websockets API to present an interface for comminicating with and controlling one or more Pixelblazes.

## Video Walkthrough

<iframe src="//www.youtube.com/embed/CGz1-_K2PSw" frameborder="0" allowfullscreen="allowfullscreen"></iframe>
